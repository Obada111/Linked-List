...
<text x="430" y="42" text-anchor="middle" font-size="22" font-weight="700" fill="#e2e8f0" letter-spacing="1">Singly Linked List — Visual Guide</text> <line x1="60" y1="54" x2="800" y2="54" stroke="#2d3748" stroke-width="1.5"/>
...
<text x="230" y="150" text-anchor="middle" font-size="10" fill="#718096">data</text> <text x="280" y="150" text-anchor="middle" font-size="10" fill="#718096">pointer</text>
...
<text x="104" y="212" text-anchor="middle" font-size="11" fill="#f6ad55" font-weight="600">head</text> <line x1="104" y1="215" x2="104" y2="228" stroke="#f6ad55" stroke-width="1.5" marker-end="url(#arrowOrange)"/>
...
<text x="483" y="296" text-anchor="middle" font-size="11" fill="#f6ad55" font-weight="600">tail</text> <line x1="483" y1="280" x2="483" y2="293" stroke="#f6ad55" stroke-width="1.5"/>

<text x="111" y="284" text-anchor="middle" font-size="9" fill="#718096">[0]</text> <text x="235" y="284" text-anchor="middle" font-size="9" fill="#718096">[1]</text> <text x="359" y="284" text-anchor="middle" font-size="9" fill="#718096">[2]</text> <text x="483" y="284" text-anchor="middle" font-size="9" fill="#718096">[3]</text>
...
<text x="500" y="348" font-size="10" fill="#9f7aea" font-family="Consolas, monospace">node->next = head;</text> <text x="500" y="364" font-size="10" fill="#9f7aea" font-family="Consolas, monospace">head = node;</text> <text x="500" y="380" font-size="10" fill="#718096">head pointer moves to new node</text>
...
<text x="500" y="465" font-size="10" fill="#9f7aea" font-family="Consolas, monospace">prev->next = cur->next;</text> <text x="500" y="480" font-size="10" fill="#9f7aea" font-family="Consolas, monospace">delete cur;</text> <text x="500" y="496" font-size="10" fill="#718096">node is unlinked, then freed</text>
...
<text x="66" y="562" font-size="10" fill="#718096">Before:</text> <text x="108" y="562" font-size="10" fill="#90cdf4">5 → 10 → 20 → NULL</text>

<text x="66" y="582" font-size="10" fill="#718096">After: </text> <text x="108" y="582" font-size="10" fill="#9ae6b4">20 → 10 → 5 → NULL</text>

<text x="340" y="556" font-size="10" fill="#9f7aea" font-family="Consolas, monospace">prev = NULL; cur = head;</text> <text x="340" y="570" font-size="10" fill="#9f7aea" font-family="Consolas, monospace">while (cur) {</text> <text x="356" y="584" font-size="10" fill="#9f7aea" font-family="Consolas, monospace">next=cur->next; cur->next=prev;</text> <text x="356" y="598" font-size="10" fill="#9f7aea" font-family="Consolas, monospace">prev=cur; cur=next; }</text> <text x="340" y="612" font-size="10" fill="#9f7aea" font-family="Consolas, monospace">head = prev;</text>
